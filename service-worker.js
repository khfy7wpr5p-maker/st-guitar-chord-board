const CACHE="st-guitar-chord-board-v21";
const APP_SHELL=["./","./index.html","./styles.css","./manifest.webmanifest","./apple-touch-icon.png","./favicon-16x16.png","./favicon-32x32.png","./favicon.ico","./icon-192.png","./icon-512.png","./maskable-icon-512.png","./src/app.js","./src/chord-core.js","./src/chord-labels-tr.js","./src/chord-catalog.js","./src/chord-relations.js","./src/curated-open-voicings.js","./src/voicing-library.js","./src/movable-voicings.js","./src/power-voicings.js","./src/audio-adapter.js","./src/diagram-model.js","./src/selection-state.js","./src/release-config.js","./src/standalone-guitar-audio.js","./vendor/audio/source.json"];
