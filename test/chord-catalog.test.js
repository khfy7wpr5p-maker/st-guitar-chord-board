...
test("exact symbol search returns selected chord then complete same-root family", () => {
  assert.deepEqual(suggestChordSymbols("Am"),["Am","A","A7","Amaj7","Am7","Asus2","Asus4","A5","A6","Am6","A9","Aadd9","Adim","Aaug","Am7b5"]);
  assert.deepEqual(suggestChordSymbols("E"),["E","Em","E7","Emaj7","Em7","Esus2","Esus4","E5","E6","Em6","E9","Eadd9","Edim","Eaug","Em7b5"]);
  assert.deepEqual(suggestChordSymbols("A5"),["A5","A","Am","A7","Amaj7","Am7","Asus2","Asus4","A6","Am6","A9","Aadd9","Adim","Aaug","Am7b5"]);
});

test("flat spelling remains stable across same-root suggestions", () => {
  assert.deepEqual(suggestChordSymbols("Bb5"),["Bb5","Bb","Bbm","Bb7","Bbmaj7","Bbm7","Bbsus2","Bbsus4","Bb6","Bbm6","Bb9","Bbadd9","Bbdim","Bbaug","Bbm7b5"]);
