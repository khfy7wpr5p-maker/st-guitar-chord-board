...
export const C_FAMILY_VOICINGS = Object.freeze({
  C: [
    ...
    V([-1,3,5,5,5,3],[-1,1,2,3,4,1],[{finger:1,fret:3,fromString:5,toString:1}],"A"),
  ...
  C7: [
    V([-1,3,5,3,5,6],[-1,1,2,1,3,4],[{finger:1,fret:3,fromString:5,toString:3}],"open-region"),
  ...
  Csus2: [
    ...
    V([8,10,10,7,-1,-1],[2,3,4,1,-1,-1],[],"Esus2")
  ],
  Csus4: [
    V([-1,3,3,0,1,1],[-1,3,4,0,1,1],[{finger:1,fret:1,fromString:2,toString:1}],"open"),
    V([-1,3,5,5,6,3],[-1,1,2,3,4,1],[{finger:1,fret:3,fromString:5,toString:1}],"Asus4"),
    V([8,10,10,10,8,8],[1,2,3,4,1,1],[{finger:1,fret:8,fromString:6,toString:1}],"Esus4")
  ]
});
