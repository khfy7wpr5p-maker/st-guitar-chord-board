...
export const C_FAMILY_VOICINGS = Object.freeze({
  ...
  Cm7: [
    V([-1,3,1,3,1,3],[-1,2,1,3,1,4],[{finger:1,fret:1,fromString:4,toString:2}]),
  ...
  Csus2: [
    ...
    V([8,10,10,7,8,8],[2,4,4,1,3,3],[{finger:4,fret:10,fromString:5,toString:4},{finger:3,fret:8,fromString:2,toString:1}])
  ],
  Csus4: [
    V([-1,3,3,0,1,1],[-1,3,4,0,1,1],[{finger:1,fret:1,fromString:2,toString:1}]),
    V([-1,3,5,5,6,3],[-1,1,3,3,4,1],[{finger:1,fret:3,fromString:5,toString:1},{finger:3,fret:5,fromString:4,toString:3}]),
    V([8,10,10,10,8,8],[1,3,4,4,1,1],[{finger:1,fret:8,fromString:6,toString:1},{finger:4,fret:10,fromString:4,toString:3}])
  ]
});
